...
class CudaDataset(BaseDataset):
    """
    This dataset class loads data and stores it on the GPU to speed up training by save tensor transfer operations from cpu to gpu.
